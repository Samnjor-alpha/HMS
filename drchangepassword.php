...
include 'app/controllers/dr-resetpassword.php';
?>
<!doctype html>
        ...
        <div class="row">
            <div class="col-xl-8 mx-auto">
                <div class="section-title text-center mb-55">
                    ...
                    <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s">HMS Doctor Reset password</h2>
                ...
                <div class="col-xl-8 mx-auto">
                    ...
                    if (isset($_GET["key"]) && isset($_GET["email"]) && isset($_GET["action"])
                        ...
                        if ($row==""){?>
                            ...
                            <form action=""  method="POST"  class="contact-form">
                                ...
                                <a class="btn btn-block theme-btn" href="drchangepassword.php">Reset password.</a>
                            </form>
                        <?php  }else{
                    ...
                    if(isset($_POST["email"]) && isset($_POST["action"]) &&
                        ...
                        if($error!=""){
                            ...
                            mysqli_query($conn,
                                "UPDATE doctors SET password='".$hash."' WHERE docEmail='".$email."';"
                            );
                            ...
                            <form id="login-form" class="form" method="post" action="" name="update">
                                ...
                                <a class="btn btn-block btn-info" href="doctor-login.php">Login here</a>
                            </form>

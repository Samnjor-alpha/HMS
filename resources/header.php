            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="header-top-left text-center text-md-left">
                        <ul>
                            <li><a href=""><i class="lni lni-phone"></i> <?php echo PHONE?></a></li>
                            <li><a href=""><i class="lni lni-envelope"></i> <?php echo EMAIL ?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg">
                        <a class="navbar-brand" href="">
                            <img src="<?php echo BASE_URL?>/public/assets/img/logo/logo.svg" alt="Logo">
                        </a>

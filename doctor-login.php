                ...
                <div class="col-xl-8 mx-auto">
                    ...
                    <form action=""  method="POST"  class="contact-form">
                        ...
                        <div class="form-group">
                            ...
                            <a class="align-content-lg-start" href="dr-forgot-password.php">
                                Forgot Password ?
                            </a>
                        </div>


                        <button name="logdr" type="submit" class="btn btn-block theme-btn">Login</button>
